...
@section('main')
    <div class="container mt-5 mb-5">
        <div class="mt-3 mb-2 d-flex justify-content-center">
            {{-- Ensure you have the order number available in the view --}}
            <a href="{{ route('invoice.generate', ['order_number' => $orders->first()->order_number]) }}" wire:navigate class="text-center btn btn-dark">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    {{-- <div class="p-3 m-0 d-flex justify-content-between footer">
