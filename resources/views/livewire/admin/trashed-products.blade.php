                        ...
                        <tr>
                            <td>
                                ...
                                @if (!empty($images))
                                    ...
                                    @endphp
                                    <img src="{{ asset('storage/' . $firstImage) }}" class="product-image"
                                        alt="Product Image" style="width: 100px; height: auto; object-fit: cover;">
                                @else
                            ...
                            <td>
                                <form wire:submit='force_delete({{$product->id}})' wire:confirm='Are you really want to delete this product permenantly ?' method="post"
                                    class="d-inline">
                                    @csrf
                                    @method('DELETE')
