        ...
        <div class="navbar-nav">
            <div class="nav-item text-nowrap">
                ...
                <form action="{{ route('admin.logout') }}" method="post">
                    @csrf
                    <button type="submit" class="p-2 nav-link text-warning"><i class="bi bi-box-arrow-right"></i> Sign
                        out</button>
                </form>
            </div>
        </div>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="pt-3 position-sticky">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a href="/admin/dashboard" wire:navigate class="nav-link {{ request()->is('admin/dashboard') ? 'active-link' : '' }}" aria-current="page" >
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('admin/products') ? 'active-link' : '' }}" wire:navigate href="/admin/products">
                                <i class="bi bi-boxes"></i>
                                Products
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('admin/categories') ? 'active-link' : '' }}" wire:navigate href="/admin/categories">
