<div>
    <div class="container my-3">
        ...
        <h5 class="mt-4 text-center">Order Summary</h5>
        <table class="table text-center rounded shadow table-bordered">
            ...
            <tbody>
                ...
                @foreach ($cart as $productId => $details)
                    <tr>
                        <td><img src="{{ asset('storage/' . $details['image']) }}" alt="{{ $details['name'] }}"
        ...
        <form wire:submit='placeOrder' method="POST">
            @csrf
            <div class="container p-2 card w-50">
                ...
                <button type="submit" class="mx-auto shadow btn btn-dark w-50"><i class="bi bi-cart-check-fill"></i> Place Order</button>
            </div>
        </form>
    </div>
</div>
